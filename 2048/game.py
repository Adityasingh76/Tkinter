...
class game(tk.Frame):
    ...
    def bind_keyboard_buttons(self):
        global menu1
        self.master.bind("<Up>",lambda event,x = "Up": self.move_buttons(event,x))
        self.master.bind("<Down>",lambda event , x = "Down":self.move_buttons(event,x))
        self.master.bind("<Right>",lambda event,x = "Right":self.move_buttons(event,x))
        self.master.bind("<Left>",lambda event,x = "Left":self.move_buttons(event,x))
    ...
    def check_result(self):
        ...
        a = 0
        for i in range(4):
            self.merge_buttons(directions[i])
            a += self.movement_no
        if a != 0:
            pass
        else:
    ...
    def merge_buttons(self,x):
        ...
        for i in range(4):
            if self.button_lst[i][3]["image"] == "pyimage1":
                if self.button_lst[i][2]["image"] == "pyimage1":
                    if self.button_lst[i][1]["image"] == "pyimage1":
                        if self.button_lst[i][0]["image"] == "pyimage1":
                            continue
                        if self.button_lst[i][0]["image"] != "pyimage1":
                            self.button_lst[i][3]["image"] = self.button_lst[i][0]["image"]
                            self.button_lst[i][0]["image"] = self.p1
                            self.movement_no += 1
                            continue

                    if self.button_lst[i][1]["image"] != "pyimage1":
                        if self.button_lst[i][0]["image"] == "pyimage1":
                            self.button_lst[i][3]["image"] = self.button_lst[i][1]["image"]
                            self.button_lst[i][1]["image"] = self.p1
                            self.movement_no += 1
                            continue
                        if self.button_lst[i][0]["image"] != "pyimage1":
                            if self.button_lst[i][0]["image"] == self.button_lst[i][1]["image"]:
                                self.button_lst[i][3]["image"] = self.button_no[self.button_dict.index(self.button_lst[i][0]["image"])+1]
                                self.score += self.score_lst[self.button_dict.index(self.button_lst[i][0]["image"])+1]
                                self.button_lst[i][0]["image"] = self.p1
                                self.button_lst[i][1]["image"] = self.p1
                                self.movement_no += 1
                                continue
                                ...
                                self.button_lst[i][3]["image"] = self.button_lst[i][1]["image"]
                                self.button_lst[i][2]["image"] = self.button_lst[i][0]["image"]
                                self.button_lst[i][0]["image"] = self.p1
                                self.button_lst[i][1]["image"] = self.p1
                                self.movement_no += 1
                                continue
                if self.button_lst[i][2]["image"] != "pyimage1":
                    if self.button_lst[i][1]["image"] == "pyimage1":
                        if self.button_lst[i][0]["image"] == "pyimage1":
                            self.button_lst[i][3]["image"] = self.button_lst[i][2]["image"]
                            self.button_lst[i][2]["image"] = self.p1
                            self.movement_no += 1
                            continue
                        if self.button_lst[i][0]["image"] != "pyimage1":
                            if self.button_lst[i][2]["image"] == self.button_lst[i][0]["image"]:
                                self.button_lst[i][3]["image"] = self.button_no[self.button_dict.index(self.button_lst[i][2]["image"])+1]
                                self.score += self.score_lst[self.button_dict.index(self.button_lst[i][0]["image"])+1]
                                self.button_lst[i][2]["image"] = self.p1
                                self.button_lst[i][0]["image"] = self.p1
                                self.movement_no += 1
                    ...
                    if self.button_lst[i][1]["image"] != "pyimage1":
                        if self.button_lst[i][0]["image"] == "pyimage1":
                            if self.button_lst[i][2]["image"] == self.button_lst[i][1]["image"]:
                                self.button_lst[i][3]["image"] = self.button_no[self.button_dict.index(self.button_lst[i][1]["image"])+1]
                                self.score += self.score_lst[self.button_dict.index(self.button_lst[i][1]["image"])+1]
                                self.button_lst[i][2]["image"] = self.p1
                                self.button_lst[i][1]["image"] = self.p1
                                self.movement_no += 1
                                continue
                                ...
                                self.button_lst[i][3]["image"] = self.button_lst[i][2]["image"]
                                self.button_lst[i][2]["image"] = self.button_lst[i][1]["image"]
                                self.button_lst[i][1]["image"] = self.p1
                                self.movement_no += 1
                                continue
                        if self.button_lst[i][0]["image"] != "pyimage1":
                            ...
                            if self.button_lst[i][0]["image"] == self.button_lst[i][1]["image"]:
                                self.button_lst[i][3]["image"] = self.button_lst[i][2]["image"]
                                self.button_lst[i][2]["image"] = self.button_no[self.button_dict.index(self.button_lst[i][0]["image"])+1]
                                self.score += self.score_lst[self.button_dict.index(self.button_lst[i][0]["image"])+1]
                                self.button_lst[i][0]["image"] = self.p1
                                self.button_lst[i][1]["image"] = self.p1
                                self.movement_no += 1
                                ...
                                self.button_lst[i][3]["image"] = self.button_lst[i][2]["image"]
                                self.button_lst[i][2]["image"] = self.button_lst[i][1]["image"]
                                self.button_lst[i][1]["image"] = self.button_lst[i][0]["image"]
                                self.button_lst[i][0]["image"] = self.p1
                                self.movement_no += 1
                                continue
            ...
            if self.button_lst[i][3]["image"] != "pyimage1":
                if self.button_lst[i][2]["image"] == "pyimage1":
                    if self.button_lst[i][1]["image"] == "pyimage1":
                        if self.button_lst[i][0]["image"] == "pyimage1":
                            continue
                        if self.button_lst[i][0]["image"] != "pyimage1":
                            if self.button_lst[i][0]["image"] == self.button_lst[i][3]["image"]:
                                self.button_lst[i][3]["image"] = self.button_no[self.button_dict.index(self.button_lst[i][0]["image"])+1]
                                self.score += self.score_lst[self.button_dict.index(self.button_lst[i][3]["image"])+1]
                                self.button_lst[i][0]["image"] = self.p1
                                self.movement_no += 1
                                continue
                            else:
                    ...
                    if self.button_lst[i][1]["image"] != "pyimage1":
                        if self.button_lst[i][0]["image"] == "pyimage1":
                            if self.button_lst[i][3]["image"] == self.button_lst[i][1]["image"]:
                                self.button_lst[i][3]["image"] = self.button_no[self.button_dict.index(self.button_lst[i][1]["image"])+1]
                                self.score += self.score_lst[self.button_dict.index(self.button_lst[i][1]["image"])+1]
                                self.button_lst[i][1]["image"] = self.p1
                                self.movement_no += 1
                        ...
                        if self.button_lst[i][0]["image"] != "pyimage1":
                            if self.button_lst[i][3]["image"] == self.button_lst[i][1]["image"]:
                                ...
                                self.movement_no += 1
                                continue
                            if self.button_lst[i][1]["image"] == self.button_lst[i][0]["image"]:
                                self.button_lst[i][2]["image"] = self.button_no[self.button_dict.index(self.button_lst[i][0]["image"])+1]
                                self.score += self.score_lst[self.button_dict.index(self.button_lst[i][0]["image"])+1]
                                self.button_lst[i][1]["image"] = self.p1
                                self.button_lst[i][0]["image"] = self.p1
                ...
                if self.button_lst[i][2]["image"] != "pyimage1":
                    if self.button_lst[i][1]["image"] == "pyimage1":
                        if self.button_lst[i][0]["image"] == "pyimage1":
                            if self.button_lst[i][3]["image"] == self.button_lst[i][2]["image"]:
                                self.button_lst[i][3]["image"] = self.button_no[self.button_dict.index(self.button_lst[i][2]["image"])+1]
                                self.score += self.score_lst[self.button_dict.index(self.button_lst[i][2]["image"])+1]
                                self.button_lst[i][2]["image"] = self.p1
                                self.movement_no += 1
                            else:
                                continue
                        if self.button_lst[i][0]["image"] != "pyimage1":
                            if self.button_lst[i][3]["image"] == self.button_lst[i][2]["image"]:
                                ...
                                self.movement_no += 1
                                continue
                            if self.button_lst[i][0]["image"] == self.button_lst[i][2]["image"]:
                                self.button_lst[i][2]["image"] = self.button_no[self.button_dict.index(self.button_lst[i][0]["image"])+1]
                                self.score += self.score_lst[self.button_dict.index(self.button_lst[i][0]["image"])+1]
                                self.button_lst[i][0]["image"] = self.p1
                                self.movement_no += 1
                    ...
                    if self.button_lst[i][1]["image"] != "pyimage1":
                        if self.button_lst[i][0]["image"] == "pyimage1":
                            if self.button_lst[i][3]["image"] == self.button_lst[i][2]["image"]:
                                ...
                                self.button_lst[i][1]["image"] = self.p1
                                self.movement_no += 1
                            if self.button_lst[i][1]["image"] == self.button_lst[i][2]["image"]:
                                self.button_lst[i][2]["image"] = self.button_no[self.button_dict.index(self.button_lst[i][1]["image"])+1]
                                self.score += self.score_lst[self.button_dict.index(self.button_lst[i][1]["image"])+1]
                                self.button_lst[i][1]["image"] = self.p1
                                self.movement_no += 1
                                continue
                        if self.button_lst[i][0]["image"] != "pyimage1":
                            if self.button_lst[i][3]["image"] == self.button_lst[i][2]["image"]:
                                ...
                                if self.button_lst[i][0]["image"] == self.button_lst[i][1]["image"]:
                                    self.button_lst[i][1]["image"] = self.button_no[self.button_dict.index(self.button_lst[i][0]["image"])+1]
                                    self.score += self.score_lst[self.button_dict.index(self.button_lst[i][0]["image"]) + 1]
                                    self.button_lst[i][0]["image"] = self.p1
                                    self.movement_no += 1
                                    continue
